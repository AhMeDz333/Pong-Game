...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("backgroundSound", "backgroundSound");
		type.set ("backgroundSound", AssetType.SOUND);
		path.set ("backgroundImg", "backgroundImg");
		type.set ("backgroundImg", AssetType.IMAGE);
